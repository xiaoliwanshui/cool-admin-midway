...
import * as entity2 from './modules/video/entity/video_line';
import * as entity3 from './modules/video/entity/video_album_relationship';
import * as entity4 from './modules/video/entity/videos';
import * as entity5 from './modules/video/entity/swiper';
import * as entity6 from './modules/video/entity/play_line';
import * as entity7 from './modules/video/entity/player';
import * as entity8 from './modules/video/entity/live';
import * as entity9 from './modules/video/entity/hot_keyword';
import * as entity10 from './modules/video/entity/collection_task';
...
import * as entity31 from './modules/dict/entity/type';
import * as entity32 from './modules/dict/entity/info';
import * as entity33 from './modules/demo/entity/goods';
import * as entity34 from './modules/base/entity/base';
import * as entity35 from './modules/base/entity/sys/user_role';
import * as entity36 from './modules/base/entity/sys/user';
import * as entity37 from './modules/base/entity/sys/role_menu';
import * as entity38 from './modules/base/entity/sys/role_department';
import * as entity39 from './modules/base/entity/sys/role';
import * as entity40 from './modules/base/entity/sys/param';
import * as entity41 from './modules/base/entity/sys/menu';
import * as entity42 from './modules/base/entity/sys/log';
import * as entity43 from './modules/base/entity/sys/department';
import * as entity44 from './modules/base/entity/sys/conf';
import * as entity45 from './modules/application/entity/noticeInfo';
import * as entity46 from './modules/application/entity/feedbackInfo';
import * as entity47 from './modules/application/entity/ads';
